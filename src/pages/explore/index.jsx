    ...
    return(
        <div className="min-h-screen">
                ...
                <div className="flex">
                    ...
                    <div className="border-y-2 border-l-2 border-black bg-zinc-400 min-h-64 ml-4 md:ml-16 w-2/3 rounded-l-xl my-4 flex-col "> 
                    ...
                    <div className="border-2 border-black bg-gray-500 min-h-64 w-1/3 mr-4 md:mr-16 rounded-r-xl my-4 pl-2 pb-2 flex-col ">
